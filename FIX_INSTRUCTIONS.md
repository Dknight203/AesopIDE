# Manual Fix Instructions for ipcHandlers.js

## Location
Insert this code at **line 309** (right after the `memory:load` handler closes with `});` and before the comment `// GIT using simple-git`)
